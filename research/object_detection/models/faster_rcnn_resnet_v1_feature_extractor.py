...
class FasterRCNNResnetV1FeatureExtractor(
  ...
  def __init__(self,
    ...
    self._has_coupled_domains = False
...
class FasterRCNNResnet101DAFeatureExtractor(faster_rcnn_meta_arch.FasterRCNNFeatureExtractor):
  """Faster R-CNN Resnet 101 feature extractor implementation."""
